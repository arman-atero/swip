...
<div class="wr-cat category-page">
	<div id="cs-content" class="cs-content">
		<div id="x-section-1" class="x-section cs-ta-center" style="margin: 0px;padding: 220px 0px 310px; background-color: transparent;">
			<div class="x-container max width" style="margin: 0px auto;padding: 0px;">
              ...
              foreach( $categories as $category ) {
                  echo '<span class="cat-name">' . $category->name .'</span>';
					...
					<!-- <p>
						Find pointers on how to make your project the next big thing
					</p> -->
				</div>
			</div>
		</div>
	...
	<section>
		<article  id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="main-category">
					<div class="container">
						<div class="col70 category-content">
						<?php 
								if ( have_posts() ) :
										while (have_posts()) : the_post();
											...
											<div class="relative-block">
												...
												<div class="post-details">
													...
													<div class="category-excerpt"><?php the_excerpt(); ?></div>
