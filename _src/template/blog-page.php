			...
			<div class="x-container max width" style="margin: 0px auto;padding: 0px;">
				<div class="x-column x-sm x-1-1" style="padding: 0px;">
					<h1 class="h-custom-headline cs-ta-center" style="color: hsl(0, 0%, 100%);font-size:50px;margin-top:20px;margin-bottom:0px;">
						<span><?php //pll_e('The Crowd Can Innovate Better!'); ?>Blog</span>
					</h1>
					<p>
				...
				<div class="main-blog">
						<div class="container">
							...
							<?php query_posts( array( 'posts_per_page' => 3, 'paged' => ( get_query_var( 'paged' ) ? get_query_var( 'paged' ) : 1 ),
									...
									endwhile;endif;
										wp_reset_postdata(); ?>
             <div aria-label="First group" role="group" class="col-inset-2 text-center btn-group"><?php echo  wpbeginner_numeric_posts_nav(); ?></div>
								</div>
								<div class="col30">
